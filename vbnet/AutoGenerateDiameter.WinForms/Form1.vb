...
Public Partial Class Form1
        ...
        Using dialog As New OpenFileDialog With {
            ...
            Try
                Using alignmentDialog As New ManualImageAlignmentDialog(dialog.FileName)
                    ...
                    Application.DoEvents()
                    Dim result = New ManualCompareService().CompareImage(preparedImagePath, _report.Sheets(_pageIndex))
                    ResetManualCompare()
    ...
    Private Shared Sub DeleteTemporaryImage(path As String)
        ...
        If Not fileName.StartsWith("AutoGenerateDiameter-aligned-", StringComparison.OrdinalIgnoreCase) Then Return
        Try
